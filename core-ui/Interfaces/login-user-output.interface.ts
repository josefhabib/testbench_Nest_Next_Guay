...
/**
 * Interface representing the output of the loginUser function.
 * 
 * @remarks
 * This interface is used to define the structure of the output returned by the loginUser function.
